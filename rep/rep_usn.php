...
<html>
  ...
  <body>
    <div class="row">
      <div class="col s12 m12">
        ...
        <?php
          ...
          $check_sql = "SELECT * FROM stu_master WHERE usn='".$_POST['usn']."' AND year='".$year."' AND section='".$sec."';";
          ...
          else
          {
            ...
            echo "<div class='row' style='width:100%;padding:0px;margin:0px'>
                    ...
                    <div id='usn' class='col m6' style='font-size:200%'>".strtoupper($_POST['usn'])."</div>
                  </div>
            ...
            echo '<div id="mp" class=""><table style="width:100%">
              ...
              <tbody>';
              $sql = "SELECT * FROM ".$row1['year']."_".$row1['section']." WHERE usn='".$_POST['usn']."';";
    ...
    <div class="fixed-action-btn">
      <a href="rep_usn_index.php" class="btn-floating btn-large yellow darken-3">
