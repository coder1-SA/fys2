...
<html>
  <head>
    <meta charset="utf-8">
    <title>Section Reports Index</title>
      ...
      <div class="col s12 m12">
        <div id="h" class="card light-blue z-depth-3">
          <div class="card-content white-text center">
            ...
            <h5>Section Report Index</h5>
          </div>
        </div>
      </div>
    </div>

    <form action="rep_sec.php" method="post">
      <div class="row">
        <div class="col s12 m8 offset-m2">
          <div id="h" class="card grey lighten-5 z-depth-1">
              ...
              <div class="row">
                ...
                <div class="col m3 input-field">
                  <select id='sec' name='sec' class='browser-default' required>
                    ...
                    <?php
                      $sql = "SELECT distinct(section) AS y FROM stu_master;";
                      $res = mysqli_query($conn,$sql);
                      while($row=mysqli_fetch_array($res, MYSQLI_ASSOC))
                      {
                        echo "<option value='".base64_encode($row['y'])."'>".$row['y']."</option>";
            ...
            <div class="center">
              <button id="em" class="btn waves-effect waves-light light-blue" type="submit" name="action">VIEW
