  ...
  <body>
          ...
          if($disptype==1)
          {
            ...
            else
            {
              echo '<div class="row">
                      ...
                      <select id="s1" name="out_of" class="browser-default" required>
              ...
              while($row = mysqli_fetch_array($res, MYSQLI_ASSOC))
              {
                ...
                echo '<div class="row">
                        <div class="col m3 offset-m2 name">
                          <input tabindex=-1 type="text" name="name'.$i.'" value="'.$row['name'].'" readonly/>
                        </div>
                        <div class="col m2 name">
                          <input tabindex=-1 type="text" name="usn'.$i.'" value="'.$row1['usn'].'" readonly/>
                        </div>
          ...
          elseif($disptype==2)
          {
            ...
            else
            {
              echo '<div class="row">
                      ...
                      <select id="s2" name="t_out_of" class="browser-default" required>
                      ...
                      <div class="col m4">
                      <select id="s3" name="q_out_of" class="browser-default" required>
              ...
              while($row = mysqli_fetch_array($res, MYSQLI_ASSOC))
              {
                ...
                echo '<div class="row">
                        ...
                        if($row['c1']==0)
                        {
                          echo '<input tabindex=1 placeholder="'.strtoupper($mt[0]).' Value" type="text" name="m'.$i.'" />';
                        }
                        else
                        {
                          echo '<input tabindex=1 value="Already Entered" type="text" name="m'.$i.'" readonly/>';
                        }
                        echo '</div>';
                        ...
                        if($row['c2']==0)
                        {
                          echo '<input tabindex=2 placeholder="'.strtoupper($mt[1]).' Value" type="text" name="q'.$i.'" />';
                        }
                        else
                        {
                          echo '<input tabindex=2 value="Already Entered" type="text" name="q'.$i.'" readonly/>';
                        }
                        echo '</div>
                      </div>';
                $i=$i+1;
    ...
    <script type="text/javascript">
      ...
      $('#sub').click(function(){
        ...
        {
          if((document.getElementById('s2').value!="" && document.getElementById('s3').value!=""))
            {
